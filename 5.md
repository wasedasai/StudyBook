...
:warning: `<BranchName>`は、`akinori/create-header-component`、`akinori/create-`や`akinori/add-logo-to-header-component`のように、自分の名前を入れた何をしようとしているのかパット見て分かるようなブランチ名にしてください。
```bash
